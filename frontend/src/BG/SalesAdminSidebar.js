  ...
  return (
    <div className="sidebar">
      ...
      <ul>
        ...
        <li><Link to="/sales-admin/dashboard"><FontAwesomeIcon icon={faTruck} /> Delivery</Link></li>
        <li><Link to="/sales-admin/dashboard"><FontAwesomeIcon icon={faChartLine} /> Sales</Link></li>
        <li><Link to="/sales-admin/dashboard"><FontAwesomeIcon icon={faBox} /> Inventory</Link></li>
      </ul>
    </div>
  );
};
